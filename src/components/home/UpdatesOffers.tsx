...
const UpdatesOffers = () => {
  return (
    <div className="relative w-full max-w-5xl mx-auto rounded-md overflow-hidden mt-2">
      ...
      <div className="flex gap-4">
        ...
        <div className="relative bg-red-700 p-4 flex flex-col items-center">
          ...
          <h3 className="text-white text-xl font-bold mt-16">ASSASSIN'S CREED SHADOWS</h3>
